...
WORKDIR /src
COPY ["BotGubakha.csproj", "."]
RUN dotnet restore "./BotGubakha.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./BotGubakha.csproj" -c %BUILD_CONFIGURATION% -o /app/build
...
WORKDIR /app
COPY --from=publish /app/publish .
>>>>>>> b151a39e34952c9354e8a90cb368a14f5799dd74
